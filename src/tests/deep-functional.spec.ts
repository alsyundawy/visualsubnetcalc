...
test("Deep Functional Test", async ({ page }) => {
  ...
  await page
    .getByLabel("172.24.0.0/13", { exact: true })
    .getByText("/13", { exact: true })
    .click();
  await page
    .getByLabel("172.24.0.0/14", { exact: true })
    .getByText("/14", { exact: true })
    .click();
  await page
    .getByLabel("172.26.0.0/15", { exact: true })
    .getByText("/15", { exact: true })
    .click();
  await page
    .getByLabel("172.26.0.0/16", { exact: true })
  ...
  await page
    .getByLabel("172.31.128.0/17", { exact: true })
    .getByText("/17", { exact: true })
    .click();
  await page
    .getByLabel("172.31.192.0/18", { exact: true })
    .getByText("/18", { exact: true })
    .click();
  await page
    .getByLabel("172.31.224.0/19", { exact: true })
    .getByText("/19", { exact: true })
    .click();
  await page
    .getByLabel("172.31.192.0/19", { exact: true })
    .getByText("/19", { exact: true })
    .click();
  await page.getByRole("textbox", { name: "172.31.240.0/20 Note" }).click();
  await page
    .getByRole("textbox", { name: "172.31.240.0/20 Note" })
    .fill("Test A");
  await page.getByRole("textbox", { name: "172.31.224.0/20 Note" }).click();
  await page
    .getByRole("textbox", { name: "172.31.224.0/20 Note" })
    .fill("Test B");
  await page.getByRole("cell", { name: "172.31.240.0/20 Split" }).click();
  await page.getByRole("textbox", { name: "172.31.240.0/21 Note" }).click();
  await page
    .getByRole("textbox", { name: "172.31.240.0/21 Note" })
    .fill("Test A - 1");
  await page.getByRole("cell", { name: "172.31.248.0/21 Note" }).click();
  await page
    .getByRole("textbox", { name: "172.31.248.0/21 Note" })
    .fill("Test A - 2");
  await page
    .getByLabel("172.31.248.0/21", { exact: true })
    .getByText("/21", { exact: true })
    .click();
  await page
    .getByLabel("172.31.252.0/22", { exact: true })
  ...
  await page
    .getByRole("textbox", { name: "172.31.240.0/22 Note" })
    .fill("Test A - 1A");
  await page.getByRole("textbox", { name: "172.31.244.0/22 Note" }).click();
  await page
    .getByRole("textbox", { name: "172.31.244.0/22 Note" })
    .fill("Test A - 1B");
  // Join a subnet
  ...
  await expect(
    page.getByRole("textbox", { name: "172.31.254.0/23 Note" }),
  ).toHaveValue("Test A - 2");
  await expect(
    page.getByRole("textbox", { name: "172.31.252.0/23 Note" }),
  ).toHaveValue("Test A - 2");
  await expect(page.getByRole("textbox", { name: "/22 Note" })).toHaveValue(
    "Test A - 2",
  );
  await expect(page.getByRole("textbox", { name: "/21 Note" })).toBeEmpty();
  await expect(
    page.getByRole("textbox", { name: "172.31.224.0/20 Note" }),
  ).toHaveValue("Test B");
  await expect(
    page
      .getByLabel("172.16.0.0/13", { exact: true })
      .getByLabel("Split", { exact: true }),
  ).toContainText("/13");
  await expect(
    page
      .getByLabel("172.24.0.0/17", { exact: true })
      .getByLabel("Split", { exact: true }),
  ).toContainText("/17");
  await expect(
    page
      .getByLabel("172.26.128.0/19", { exact: true })
      .getByLabel("Split", { exact: true }),
  ).toContainText("/19");
  await expect(
    page
      .getByLabel("172.27.0.0/16", { exact: true })
      .getByLabel("Split", { exact: true }),
  ).toContainText("/16");
  await expect(
    page
      .getByLabel("172.28.0.0/15", { exact: true })
      .getByLabel("Split", { exact: true }),
  ).toContainText("/15");
  await expect(
    page
      .getByLabel("172.30.0.0/16", { exact: true })
      .getByLabel("Split", { exact: true }),
  ).toContainText("/16");
  await expect(
    page
      .getByLabel("172.31.0.0/17", { exact: true })
      .getByLabel("Split", { exact: true }),
  ).toContainText("/17");
  await expect(
    page
      .getByLabel("172.31.128.0/18", { exact: true })
      .getByLabel("Split", { exact: true }),
  ).toContainText("/18");
  await expect(
    page
      .getByLabel("172.31.192.0/20", { exact: true })
      .getByLabel("Split", { exact: true }),
  ).toContainText("/20");
  await expect(
    page
      .getByLabel("172.31.240.0/21", { exact: true })
      .getByLabel("Split", { exact: true }),
  ).toContainText("/21");
  await expect(
    page
      .getByLabel("172.31.248.0/22", { exact: true })
      .getByLabel("Split", { exact: true }),
  ).toContainText("/22");
  await expect(
    page
      .getByLabel("172.31.252.0/23", { exact: true })
      .getByLabel("Split", { exact: true }),
  ).toContainText("/23");
  ...
  await expect(page.getByRole("row", { name: "172.26.128.0/19" })).toHaveCSS(
    "background-color",
    "rgb(255, 198, 255)",
  );
  await expect(page.getByRole("row", { name: "172.26.160.0/19" })).toHaveCSS(
    "background-color",
    "rgb(255, 198, 255)",
  );
  await expect(page.getByRole("row", { name: "172.26.192.0/19" })).toHaveCSS(
    "background-color",
    "rgb(202, 255, 191)",
  );
  await expect(page.getByRole("row", { name: "172.26.224.0/19" })).toHaveCSS(
    "background-color",
    "rgb(202, 255, 191)",
  );
  ...
  await expect(
    page
      .getByLabel("10.0.0.0/24", { exact: true })
      .getByLabel("Subnet Address"),
  ).toContainText("10.0.0.0/24");
  await expect(
    page
      .getByLabel("10.0.1.0/24", { exact: true })
      .getByLabel("Subnet Address"),
  ).toContainText("10.0.1.0/24");
  await expect(
    page
      .getByLabel("10.0.2.0/24", { exact: true })
      .getByLabel("Subnet Address"),
  ).toContainText("10.0.2.0/24");
  await expect(
    page
      .getByLabel("10.0.3.0/24", { exact: true })
      .getByLabel("Subnet Address"),
  ).toContainText("10.0.3.0/24");
  await expect(
    page
      .getByLabel("10.0.4.0/23", { exact: true })
      .getByLabel("Subnet Address"),
  ).toContainText("10.0.4.0/23");
  await expect(
    page
      .getByLabel("10.0.6.0/23", { exact: true })
      .getByLabel("Subnet Address"),
  ).toContainText("10.0.6.0/23");
  await expect(
    page
      .getByLabel("10.0.8.0/24", { exact: true })
      .getByLabel("Subnet Address"),
  ).toContainText("10.0.8.0/24");
  await expect(
    page
      .getByLabel("10.0.9.0/24", { exact: true })
      .getByLabel("Subnet Address"),
  ).toContainText("10.0.9.0/24");
  await expect(
    page
      .getByLabel("10.0.10.0/23", { exact: true })
      .getByLabel("Subnet Address"),
  ).toContainText("10.0.10.0/23");
  await expect(
    page
      .getByLabel("10.0.12.0/23", { exact: true })
      .getByLabel("Subnet Address"),
  ).toContainText("10.0.12.0/23");
  await expect(
    page
      .getByLabel("10.0.14.0/24", { exact: true })
      .getByLabel("Subnet Address"),
  ).toContainText("10.0.14.0/24");
  await expect(
    page
      .getByLabel("10.0.15.0/24", { exact: true })
      .getByLabel("Subnet Address"),
  ).toContainText("10.0.15.0/24");
  await expect(
    page.getByRole("textbox", { name: "10.0.0.0/24 Note" }),
  ).toHaveValue("Data Center - Virtual Servers");
  await expect(
    page.getByRole("textbox", { name: "10.0.1.0/24 Note" }),
  ).toHaveValue("Data Center - Virtual Servers");
  await expect(
    page.getByRole("textbox", { name: "10.0.2.0/24 Note" }),
  ).toHaveValue("Data Center - Virtual Servers");
  await expect(
    page.getByRole("textbox", { name: "10.0.3.0/24 Note" }),
  ).toHaveValue("Data Center - Physical Servers");
  await expect(
    page.getByRole("textbox", { name: "10.0.4.0/23 Note" }),
  ).toHaveValue("Building A - Wifi");
  await expect(
    page.getByRole("textbox", { name: "10.0.6.0/23 Note" }),
  ).toHaveValue("Building A - LAN");
  await expect(
    page.getByRole("textbox", { name: "10.0.8.0/24 Note" }),
  ).toHaveValue("Building A - Printers");
  await expect(
    page.getByRole("textbox", { name: "10.0.9.0/24 Note" }),
  ).toHaveValue("Building A - Voice");
  await expect(
    page.getByRole("textbox", { name: "10.0.10.0/23 Note" }),
  ).toHaveValue("Building B - Wifi");
  await expect(
    page.getByRole("textbox", { name: "10.0.12.0/23 Note" }),
  ).toHaveValue("Building B - LAN");
  await expect(
    page.getByRole("textbox", { name: "10.0.14.0/24 Note" }),
  ).toHaveValue("Building B - Printers");
  await expect(
    page.getByRole("textbox", { name: "10.0.15.0/24 Note" }),
  ).toHaveValue("Building B - Voice");
  await expect(page.getByRole("row", { name: "10.0.0.0/24" })).toHaveCSS(
    "background-color",
    "rgb(155, 246, 255)",
  );
  await expect(page.getByRole("row", { name: "10.0.1.0/24" })).toHaveCSS(
    "background-color",
    "rgb(155, 246, 255)",
  );
  await expect(page.getByRole("row", { name: "10.0.2.0/24" })).toHaveCSS(
    "background-color",
    "rgb(155, 246, 255)",
  );
  await expect(page.getByRole("row", { name: "10.0.3.0/24" })).toHaveCSS(
    "background-color",
    "rgb(160, 196, 255)",
  );
  ...
  await expect(page.getByRole("row", { name: "10.0.6.0/23" })).toHaveCSS(
    "background-color",
    "rgb(255, 214, 165)",
  );
  await expect(page.getByRole("row", { name: "10.0.8.0/24" })).toHaveCSS(
    "background-color",
    "rgb(255, 214, 165)",
  );
  await expect(page.getByRole("row", { name: "10.0.9.0/24" })).toHaveCSS(
    "background-color",
    "rgb(255, 214, 165)",
  );
  await expect(page.getByRole("row", { name: "10.0.10.0/23" })).toHaveCSS(
    "background-color",
    "rgb(253, 255, 182)",
  );
  await expect(page.getByRole("row", { name: "10.0.12.0/23" })).toHaveCSS(
    "background-color",
    "rgb(253, 255, 182)",
  );
  await expect(page.getByRole("row", { name: "10.0.14.0/24" })).toHaveCSS(
    "background-color",
    "rgb(253, 255, 182)",
  );
  await expect(page.getByRole("row", { name: "10.0.15.0/24" })).toHaveCSS(
    "background-color",
    "rgb(253, 255, 182)",
  );
